...
<head>
    <meta charset="UTF-8">
    <title>Respuesta Desestimatoria al Derecho de Acceso</title>
    <style>
        body {
...
<body>
    <h2 style="text-align:center; margin-bottom:20px;">Respuesta desestimatoria al ejercicio del derecho de acceso</h2>
    ...
    <p>
        Que se desestima su petición de ejercicio del derecho de acceso a la información sobre sus datos de carácter personal contenidos en el fichero de esta empresa, por los siguientes motivos:
    </p>
