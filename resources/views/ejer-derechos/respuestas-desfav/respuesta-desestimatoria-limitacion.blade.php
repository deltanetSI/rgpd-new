...
<head>
    <meta charset="UTF-8">
    <title>Respuesta Desestimatoria al Ejercicio de Limitación de Tratamiento</title>
    <style>
        body {
...
<body>
    <h2 style="text-align:center; margin-bottom:20px;">Respuesta desestimatoria al ejercicio de limitación de tratamiento</h2>
    ...
    <p>
        Que se desestima su petición de ejercicio del derecho de limitación al Tratamiento de sus datos de carácter personal contenidos en el fichero de esta empresa, por los siguientes motivos:
    </p>
